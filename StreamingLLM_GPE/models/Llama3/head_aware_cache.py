"""
Head-Aware Dynamic KV Cache for Llama3
...
# Import the custom DynamicCache from llama_streaming (which has pop method)
from StreamingLLM_GPE.models.Llama3.llama_streaming import DynamicCache as LlamaDynamicCache


class HeadAwareDynamicCache(LlamaDynamicCache):
    """
    Head-Aware Dynamic KV Cache for Llama3
